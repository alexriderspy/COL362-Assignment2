with 
a0 as (
    select * from person where creationdate :varies
),
a1 as (
    select * from person_studyat_university where universityid :varies
),
u1 as (
    select
...
c1 as (
    ...
    where
        ...
        and creationdate > '2010-06-01'
        and creationdate < '2012-07-01'
),
d1 as (
    select
        distinct person1id,
